...
type OpenCardResult_S2C struct {
	...
	BlackCard []int32 `protobuf:"varint,2,rep,packed,name=BlackCard,proto3" json:"BlackCard,omitempty"`
	//2、比牌类型
	CardType CardsType `protobuf:"varint,3,opt,name=cardType,proto3,enum=pb_msg.CardsType" json:"cardType,omitempty"`
	//3、注池Win类型, True为 Win,False为 Lose
	PotWinTypes          *DownPotType `protobuf:"bytes,4,opt,name=PotWinTypes,proto3" json:"PotWinTypes,omitempty"`
	XXX_NoUnkeyedLiteral struct{}     `json:"-"`
	XXX_unrecognized     []byte       `json:"-"`
	XXX_sizecache        int32        `json:"-"`
}
...
var fileDescriptor_bd13c7201b21be60 = []byte{
	...
	,
}
