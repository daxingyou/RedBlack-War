...
const (
	...
	MessageID_MSG_lGameHallTime_S2C  MessageID = 18
)
...
type GameHallTime_S2C struct {
	GameStage            GameStage        `protobuf:"varint,1,opt,name=gameStage,proto3,enum=pb_msg.GameStage" json:"gameStage,omitempty"`
	HallTime             map[string]int32 `protobuf:"bytes,2,rep,name=hallTime,proto3" json:"hallTime,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
}
...
func (m *GameHallTime_S2C) GetGameStage() GameStage {
	if m != nil {
		return m.GameStage
	}
	return GameStage_XXX_Stage
...
func (m *GameHallTime_S2C) GetHallTime() map[string]int32 {
	if m != nil {
		return m.HallTime
	}
	return nil
...
func init() {
	...
	proto.RegisterMapType((map[string]int32)(nil), "pb_msg.GameHallTime_S2C.HallTimeEntry")
}
...
var fileDescriptor_bd13c7201b21be60 = []byte{
	...
	,
}
